...
label_0 = Label(root, text="Registration Form",width=130,font=("bold", 16),bg="#180020",fg='white')
label_0.place(x=00,y=65)

##################  form begin  ######################

label_1 = Label(root, text="Name    *",width=20,font=("bold", 12),bg="#7AC5CD")
label_1.place(x=70,y=130)

entry_1 = Entry(root,width=50,textvar=Fullname)
entry_1.place(x=260,y=130)

label_2 = Label(root, text="Father Name",width=20,font=("bold", 12),bg="#7AC5CD")
label_2.place(x=70,y=180)

entry_2 = Entry(root,width=50,textvar=Fathername)
entry_2.place(x=260,y=180)

label_3 = Label(root, text="Gender      *",width=20,font=("bold", 12),bg="#7AC5CD")
label_3.place(x=70,y=280)

Radiobutton(root, text="Male",padx = 5, variable=gen, value=1,bg="#7AC5CD").place(x=260,y=280)
Radiobutton(root, text="Female",padx = 20, variable=gen, value=2,bg="#7AC5CD").place(x=315,y=280)

label_4 = Label(root, text="Mother Name",width=20,font=("bold", 12),bg="#7AC5CD")
...
label_4 = Label(root, text="Religion    *",width=20,font=("bold", 12),bg="#7AC5CD")
...
label_5 = Label(root, text="Blood Group",width=20,font=("bold", 12),bg="#7AC5CD")
