...
class App:
	def __init__(self,video_source=0):
		...
		self.window["bg"]='#7AC5CD'
		self.video_source=video_source
		self.vid=myvideocapture(self.video_source)
		self.label=Label(self.window,text="CRIMINAL FACE IDENTIFICATION SYSTEM",width=51,font=("Times New Roman", 40),anchor=CENTER,bg="#FF4500",fg="white").pack(side=TOP,fill=BOTH)
		self.label1=Label(self.window,text="Vedio Surveilliance",width=51,font=("Times New Roman", 18),anchor=CENTER,bg="black",fg="white").pack(side=TOP,fill=BOTH)
		self.canvas=Canvas(self.window,height=700,width=700,bg='#7AC5CD')
		...
		self.recognizer = cv.face_LBPHFaceRecognizer.create()
		self.recognizer.setRadius(5)
	...
	def viewdetail(self,a):
		...
		print(rows)
		for row in rows:
			label_n = Label(self.window, text=row[1],bg="#7AC5CD",fg='white',width=20,font=("bold", 12))
			label_n.place(x=1130,y=400)
			label_f = Label(self.window, text=row[3],bg="#7AC5CD",fg='white',width=20,font=("bold", 12))
			label_f.place(x=1130,y=430)
			label_m = Label(self.window, text=row[4],bg="#7AC5CD",fg='white',width=20,font=("bold", 12))
			label_m.place(x=1130,y=460)
			label_g = Label(self.window, text=row[2],bg="#7AC5CD",fg='white',width=20,font=("bold", 12))
			label_g.place(x=1130,y=490)
			label_r = Label(self.window, text=row[5],bg="#7AC5CD",fg='white',width=20,font=("bold", 12))
			label_r.place(x=1130,y=520)
			label_bl = Label(self.window, text=row[6],bg="#7AC5CD",fg='white',width=20,font=("bold", 12))
			label_bl.place(x=1130,y=550)
			label_b = Label(self.window, text=row[7],bg="#7AC5CD",fg='white',width=20,font=("bold", 12))
			label_b.place(x=1130,y=580)
			label_n = Label(self.window, text=row[8],bg="#7AC5CD",fg='white',width=20,font=("bold", 12))
			label_n.place(x=1130,y=610)
			label_c = Label(self.window, text=row[9],width=30,bg="#7AC5CD",font=("bold", 15),fg="red")
			label_c.place(x=1060,y=640)
		conn.close()
		label_name = Label(self.window, text="Name",bg="#7AC5CD",fg='yellow',width=20,font=("bold", 12))
		label_name.place(x=930,y=400)
		label_father = Label(self.window, text="FatherName",bg="#7AC5CD",fg='yellow',width=20,font=("bold", 12))
		label_father.place(x=930,y=430)
		label_mother = Label(self.window, text="MotherName",bg="#7AC5CD",fg='yellow',width=20,font=("bold", 12))
		label_mother.place(x=930,y=460)
		label_gender = Label(self.window, text="Gender",bg="#7AC5CD",fg='yellow',width=20,font=("bold", 12))
		label_gender.place(x=930,y=490)
		label_religion = Label(self.window, text="Religion",bg="#7AC5CD",fg='yellow',width=20,font=("bold", 12))
		label_religion.place(x=930,y=520)
		label_bloodgroup = Label(self.window, text="Blood Group",bg="#7AC5CD",fg='yellow',width=20,font=("bold", 12))
		label_bloodgroup.place(x=930,y=550)
		label_body = Label(self.window, text="BodyMark",bg="#7AC5CD",fg='yellow',width=20,font=("bold", 12))
		label_body.place(x=930,y=580)
		label_nat = Label(self.window, text="Nationality",bg="#7AC5CD",fg='yellow',width=20,font=("bold", 12))
		label_nat.place(x=930,y=610)
		label_crime = Label(self.window, text="Crime",bg="#7AC5CD",width=23,font=("bold", 15),fg="red")
